...
export const getMe = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('User profile retrieved successfully', transformedUser)
        );
    } catch (error) {
        next(error);
    }
...
export const updateMe = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('Profile updated successfully', transformedUser)
        );
    } catch (error) {
        next(error);
    }
...
export const handleGoogleAuth = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.CREATED).json(
            successResponse('Google registration successful', {
                token,
                user: transformedUser
            })
        );
