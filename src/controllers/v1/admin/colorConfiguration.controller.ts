...
export const getAllColorConfigurations = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse('Color configurations retrieved successfully', configurations));
    }
    catch (error) {
        next(error);
    }
...
export const createColorConfiguration = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.CREATED).json(successResponse('Color configuration created successfully', configuration));
    }
    catch (error) {
        next(error);
    }
...
export const bulkUpdateColorConfigurations = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse('Color configurations updated successfully', updated));
    }
    catch (error) {
        next(error);
    }
...
export const updateColorConfiguration = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(successResponse(SUCCESS_MESSAGES.UPDATED, configuration));
    }
    catch (error) {
        next(error);
    }
