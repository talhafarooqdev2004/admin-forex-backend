...
export const getAllEducations = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('Educations retrieved successfully', educations)
        );
    } catch (error) {
        next(error);
    }
...
export const getEducationById = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('Education retrieved successfully', education)
        );
    } catch (error) {
        next(error);
    }
...
export const createEducation = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.CREATED).json(
            successResponse(SUCCESS_MESSAGES.CREATED, education)
        );
    } catch (error) {
        next(error);
    }
...
export const publishEducation = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse(SUCCESS_MESSAGES.PUBLISHED, education)
        );
    } catch (error) {
        next(error);
    }
...
export const unpublishEducation = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse(SUCCESS_MESSAGES.UNPUBLISHED, education)
        );
    } catch (error) {
        next(error);
    }
