...
export const getAllPackages = async (req, res, next) => {
    try {
        ...
        // For public routes (/packages), only return published packages
        // For admin routes (/admin/subscription-packages), return all packages
...
export const getPackageById = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('Package retrieved successfully', pkg)
        );
    } catch (error) {
        next(error);
    }
...
export const createPackage = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.CREATED).json(
            successResponse(SUCCESS_MESSAGES.CREATED, pkg)
        );
    } catch (error) {
        next(error);
    }
...
export const publishPackage = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse(SUCCESS_MESSAGES.PUBLISHED, pkg)
        );
    } catch (error) {
        next(error);
    }
...
export const unpublishPackage = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse(SUCCESS_MESSAGES.UNPUBLISHED, pkg)
        );
    } catch (error) {
        next(error);
    }
...
export const getPackageStats = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('Package statistics retrieved successfully', stats)
        );
    } catch (error) {
        next(error);
    }
