...
export const getAllScores = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('Scores retrieved successfully', scores)
        );
    } catch (error) {
        next(error);
    }
...
export const calculateScores = async (req, res, next) => {
    try {
        ...
        // Process table mappings and calculate scores
        // This is a simplified version - you may need to implement the actual calculation logic
        // based on your DynamicTableService implementation
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('Scores calculated successfully', {})
        );
    } catch (error) {
        next(error);
    }
