...
const transformUser = (user) => {
    ...
    // Destructure to exclude snake_case fields and add camelCase
...
export const getAllUsers = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('Users retrieved successfully', transformedUsers)
        );
    } catch (error) {
        next(error);
    }
...
export const getUserById = async (req, res, next) => {
    try {
        ...
        res.status(HTTP_STATUS.OK).json(
            successResponse('User retrieved successfully', transformedUser)
        );
    } catch (error) {
        next(error);
    }
