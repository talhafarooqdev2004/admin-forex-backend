...
import tradeAlertPairRoutes from './tradeAlertPair.routes.js';
...
router.use('/admin/trade-alert-pairs', tradeAlertPairRoutes);
router.use('/admin/integrations', integrationsRoutes);
...
router.use('/admin/rss-news', rssNewsRoutes);
